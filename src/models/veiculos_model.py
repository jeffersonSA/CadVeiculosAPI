...
class VeiculosModel(db.Model):
    ...
    def __repr__(self,):
        return f'VeiculosModel(veiculo={self.veiculo},marca={self.marca},ano={self.ano},descricao={self.descricao},vendido={self.vendido},created={self.created},updated={self.updated})'
